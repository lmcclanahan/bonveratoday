...
namespace ReplicatedSite.Models.SiteMap
{
    ...
    public class NavigationSiteMapNode : ISiteMapNode, INestableSiteMapNode<ISiteMapNode>
    {
        ...
        public NavigationSiteMapNode(string id, string label, string activeGroup = "", IEnumerable<ISiteMapNode> children = null )
            : this(id, children)
        {
            Label = label;
        ...
        /// <summary>
        /// The data attribute that controls which group of pages cause this node to have an active indicator
        /// </summary>
