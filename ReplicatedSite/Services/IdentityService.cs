...
namespace ReplicatedSite.Services
{
    ...
    {
        readonly IReplicatedSiteIdentityAuthenticationProvider _authProvider = new ODataIdentityAuthenticationProvider();
        ...
        public void SignOut()
        {
            ...
            var ShoppingCart = Exigo.PropertyBags.Get<ShoppingCartItemsPropertyBag>("BonveraReplicatedSiteShoppingCart");
            var ShoppingPropertyBag = Exigo.PropertyBags.Get<ShoppingCartCheckoutPropertyBag>("BonveraReplicatedSiteShoppingPropertyBag");

            Exigo.PropertyBags.Delete(ShoppingPropertyBag);
        ...
        /// <summary>
        ///   Ensures that multiple users on the same machine will not see each other's carts
        /// </summary>
        public void UpdateShoppingCartPropertyBags(CustomerIdentity identity)
        {
            var ShoppingPropertyBag = Exigo.PropertyBags.Get<ShoppingCartCheckoutPropertyBag>("BonveraReplicatedSiteShoppingPropertyBag");
            
            if (ShoppingPropertyBag != null)
            {
                if (ShoppingPropertyBag.CustomerID == 0)
                {
                    ShoppingPropertyBag.CustomerID = identity.CustomerID;
                                        
                    Exigo.PropertyBags.Update(ShoppingPropertyBag);
                }
                else if (ShoppingPropertyBag.CustomerID != identity.CustomerID)
                {
                    var ShoppingCart = Exigo.PropertyBags.Get<ShoppingCartItemsPropertyBag>("BonveraReplicatedSiteShoppingCart");
