...
namespace Backoffice.Models
{
    public class LoginResponse
    {
        ...
        /// <summary>
        /// Specifies a URL the login should redirect to if you are unauthorized for this website. Often used for silent logins.
        /// </summary>
        public string RedirectUrl { get; set; }

        /// <summary>
        /// Specifies a URL the login should redirect to upon successfully logging in.
        /// </summary>
